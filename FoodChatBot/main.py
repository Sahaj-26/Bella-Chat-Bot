...
@app.get("/lol")
async def root():
    return {"message": "Hello World is lol"}
...
def new_order(parameters: dict, session_id: str):
    if session_id not in inprogress_orders:
        fulfillment_text = "Ok, starting a new order. You can say things like \"I want two pizzas and one mango lassi\". " \
                           ...
                           "on our menu: Pav Bhaji, Chole Bhature, Pizza, Mango Lassi, Masala Dosa, Biryani, Vada Pav, Rava Dosa, and Samosa."
        response = {
    ...
    fulfillment_text = "I have removed your previous order, and am starting a new order"
    fulfillment_text += "You can say things like \"I want two pizzas and one mango lassi\". " \
                        "Make sure to specify a quantity for every food item! Also, we have only the following items " \
                        "on our menu: Pav Bhaji, Chole Bhature, Pizza, Mango Lassi, Masala Dosa, Biryani, Vada Pav, Rava Dosa, and Samosa."
    response = {
        "fulfillmentText": fulfillment_text
